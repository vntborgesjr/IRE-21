...
streams_raw <- readxl::read_xlsx("/Usuário/Documents/Vitor/IRE-21/Dados/streams.xlsx")
streams_variables <- read_csv("/Usuário/Documents/Vitor/IRE-21/Dados/streams_variables.csv",
                               col_types = cols(
                                 stream = col_factor()
                               ))
streams_date_variables <- read_csv("/Usuário/Documents/Vitor/IRE-21/Dados/streams_date_variables.csv",
                               col_types = cols(
                                 stream = col_factor()
                               ))
tadpoles_clean <- read_tadpoles_raw("/Usuário/Documents/Vitor/IRE-21/Dados/tadpoles_raw.csv")
...
QQ-plots plotam a amostra contra um distribuição teórica, como uma normal, e desenham uma linha que intercepta os dados nos primeiro e terceiro quantis. 
